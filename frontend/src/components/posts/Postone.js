        ...
        <div className="post-preview">
          <a href="post/postone">
            <h2 className="post-title">
              Ultimate Guide to Harry Potter Video Games: Tips, Tricks, and
              Easter Eggs
            </h2>
            <h3 className="post-subtitle">
              Whether you’re a seasoned witch or wizard or new to the magical
              world of Harry Potter games, this guide will equip you with all
              the tips, tricks, and Easter eggs you need to make the most of
              your journey.
            </h3>
          </a>
                ...
                <div className="">
                  ...
                  <div className="text-center">
                    <span className="caption text-muted ">
                      To go places and do things that have never been done
                      before – that’s what living is all about.
                    </span>
                  </div>
