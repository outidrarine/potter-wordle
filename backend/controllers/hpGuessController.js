  ...
  hpCharacter.getByToken(token, (err, correctHpCharacterData) => {
    ...
    hpCharacter.getByName(guess, (err, guessHpCharacterData) => {
      ...
      const hpCharacterData = {
        ...
        roleJob: guessHpCharacterData[0].roleJob,

        keyItem: guessHpCharacterData[0].keyItem,

        loyalty: guessHpCharacterData[0].loyalty,

        magicalAbility: guessHpCharacterData[0].magicalAbility,

        firstAppearanceBookNumber: guessHpCharacterData[0].firstAppearanceBookNumber,

        gender: guessHpCharacterData[0].gender,

        keyRelationships: guessHpCharacterData[0].keyRelationships,

        house: guessHpCharacterData[0].house,

      };

      const similarites = {
        sameJob:
        guessHpCharacterData[0].roleJob === correctHpCharacterData[0].roleJob
            ? true
            : false,

        sameKeyItem:
        guessHpCharacterData[0].keyItem === correctHpCharacterData[0].keyItem
            ? true
            : false,
        sameLoyalty:
        guessHpCharacterData[0].loyalty === correctHpCharacterData[0].loyalty
          ? true
          : false,

        sameMagicalAbility:
        guessHpCharacterData[0].magicalAbility === correctHpCharacterData[0].magicalAbility
        ? true
        : false,

        sameFirstAppearance:
          correctHpCharacterData[0].firstAppearanceBookNumber === guessHpCharacterData[0].firstAppearanceBookNumber
            ? "="
            : correctHpCharacterData[0].firstAppearanceBookNumber > guessHpCharacterData[0].firstAppearanceBookNumber
            ? ">"
            : "<",
        ...
        sameHouse:
        guessHpCharacterData[0].house === correctHpCharacterData[0].house
        ? true
        : false,
